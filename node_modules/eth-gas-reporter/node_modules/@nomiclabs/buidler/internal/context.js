...
class BuidlerContext {
    ...
    static createBuidlerContext() {
        if (this.isCreated()) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.CONTEXT_ALREADY_CREATED);
        }
        const globalWithBuidlerContext = global;
    ...
    static getBuidlerContext() {
        ...
        if (ctx === undefined) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.CONTEXT_NOT_CREATED);
        }
        return ctx;
    }
    ...
    setBuidlerRuntimeEnvironment(env) {
        if (this.environment !== undefined) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.CONTEXT_BRE_ALREADY_DEFINED);
        }
        this.environment = env;
    }
    getBuidlerRuntimeEnvironment() {
        if (this.environment === undefined) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.CONTEXT_BRE_NOT_DEFINED);
        }
