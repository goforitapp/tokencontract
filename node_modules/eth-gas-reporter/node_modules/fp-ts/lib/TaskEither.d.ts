 ...
 * @since 1.19.0
 */
export declare function right2v<A>(a: A): TaskEither<never, A>;
/**
 * @since 1.19.0
 */
export declare function left2v<L>(l: L): TaskEither<L, never>;
/**
 * @since 1.19.0
 */
 ...
 * @since 1.19.0
 */
export declare function rightTask<A>(ma: Task<A>): TaskEither<never, A>;
/**
 * @since 1.19.0
 */
export declare function leftTask<E>(me: Task<E>): TaskEither<E, never>;
/**
 * @since 1.19.0
 */
