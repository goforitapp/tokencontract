import { BuidlerConfig, ProjectPaths, ResolvedBuidlerConfig } from "../../../types";
/**
 ...
 */
export declare function resolveConfig(userConfigPath: string, defaultConfig: BuidlerConfig, userConfig: BuidlerConfig): ResolvedBuidlerConfig;
/**
