...
function paramNameToEnvVariable(paramName) {
    ...
    return ArgumentsParser_1.ArgumentsParser.paramNameToCLA(paramName)
        .replace(ArgumentsParser_1.ArgumentsParser.PARAM_PREFIX, BUIDLER_ENV_ARGUMENT_PREFIX)
        .replace(/-/g, "_")
        .toUpperCase();
}
exports.paramNameToEnvVariable = paramNameToEnvVariable;
function getEnvBuidlerArguments(paramDefinitions, envVariables) {
    const envArgs = {};
    for (const paramName of unsafe_1.unsafeObjectKeys(paramDefinitions)) {
        ...
        if (rawValue !== undefined) {
            try {
                ...
                throw new errors_1.BuidlerError(errors_1.ERRORS.ARGUMENTS.INVALID_ENV_VAR_VALUE, error, envVarName, rawValue);
            }
        }
        else {
...
exports.getEnvBuidlerArguments = getEnvBuidlerArguments;
