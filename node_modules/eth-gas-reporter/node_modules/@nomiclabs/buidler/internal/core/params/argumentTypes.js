...
exports.boolean = {
    ...
    parse: (argName, strValue) => {
        ...
        throw new errors_1.BuidlerError(errors_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, strValue, argName, "boolean");
    }
};
/**
 * Int type.
...
exports.int = {
    ...
    parse: (argName, strValue) => {
        ...
        if (strValue.match(decimalPattern) === null &&
            ...
            throw new errors_1.BuidlerError(errors_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, strValue, argName, "int");
        }
...
exports.float = {
    ...
    parse: (argName, strValue) => {
        ...
        if (strValue.match(decimalPattern) === null &&
            strValue.match(hexPattern) === null) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, strValue, argName, "float");
        }
        return Number(strValue);
    }
};
...
exports.inputFile = {
    ...
    parse(argName, strValue) {
        try {
            ...
            throw new errors_1.BuidlerError(errors_1.ERRORS.ARGUMENTS.INVALID_INPUT_FILE, error, argName, strValue);
        }
        return strValue;
    }
};
exports.json = {
    ...
    parse(argName, strValue) {
        try {
            ...
            throw new errors_1.BuidlerError(errors_1.ERRORS.ARGUMENTS.INVALID_JSON_ARGUMENT, error, argName, error.message);
        }
    }
};
