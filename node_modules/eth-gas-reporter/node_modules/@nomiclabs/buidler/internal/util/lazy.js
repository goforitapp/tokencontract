...
function lazyObject(objectCreator) {
    return createLazyProxy(objectCreator, () => ({}), object => {
        if (object instanceof Function) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.UNSUPPORTED_OPERATION, "Creating lazy functions or classes with lazyObject");
        }
        if (typeof object !== "object" || object === null) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.UNSUPPORTED_OPERATION, "Using lazyObject with anything other than objects");
        }
    });
}
...
function lazyFunction(functionCreator) {
    return createLazyProxy(functionCreator, () => function () { }, object => {
        if (!(object instanceof Function)) {
            throw new errors_1.BuidlerError(errors_1.ERRORS.GENERAL.UNSUPPORTED_OPERATION, "lazyFunction should be used for functions");
        }
    });
}
...
function createLazyProxy(targetCreator, dummyTargetCreator, validator) {
    ...
    const dummyTarget = dummyTargetCreator();
    ...
    if (dummyTarget instanceof Function) {
        ...
        handler.construct = (target, argArray, newTarget) => {
            // tslint:disable-next-line ban-types
