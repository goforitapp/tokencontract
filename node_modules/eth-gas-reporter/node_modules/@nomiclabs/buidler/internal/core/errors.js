...
function isBuidlerError(error) {
    return error.isBuidlerError;
}
exports.isBuidlerError = isBuidlerError;
function isBuidlerPluginError(error) {
    return error.isBuidlerPluginError;
}
exports.isBuidlerPluginError = isBuidlerPluginError;
class BuidlerError extends Error {
    constructor(errorDescription, parentError, ...messageArguments) {
        ...
        const formattedMessage = util_1.default.format(errorDescription.message, ...messageArguments);
...
exports.ERRORS = {
    ...
    NETWORK: {
        ...
        INVALID_GLOBAL_CHAIN_ID: {
            number: 101,
            message: "Buidler was set to use chain id %s, but connected to a chain with id %s."
        },
        INVALID_TX_CHAIN_ID: {
            number: 102,
            message: "Trying to send a tx with chain id %s, but Buidler is connected to a chain with id %s."
        },
        ...
        NOT_LOCAL_ACCOUNT: {
            number: 104,
            message: 'Account "%s" is not managed by the current network access provider.'
        },
        ...
        INVALID_HD_PATH: {
            number: 107,
            message: 'HD path "%s" is invalid. Read BIP32 to know about the valid forms.'
        }
    },
    TASK_DEFINITIONS: {
        PARAM_AFTER_VARIADIC: {
            number: 200,
            message: 'Could not set positional param "%s" for task "%s" because there is already a variadic positional param and it has to be the last positional one.'
        },
        PARAM_ALREADY_DEFINED: {
            number: 201,
            message: 'Could not set param "%s" for task "%s" because its name is already used.'
        },
        PARAM_CLASHES_WITH_BUIDLER_PARAM: {
            number: 202,
            message: 'Could not set param "%s" for task "%s" because its name is used as a param for Buidler.'
        },
        MANDATORY_PARAM_AFTER_OPTIONAL: {
            number: 203,
            message: 'Could not set param "%s" for task "%s" because it is mandatory and it was added after an optional positional param.'
        },
        OVERRIDE_NO_PARAMS: {
            number: 204,
            message: 'Redefinition of task "%s" failed. You can\'t change param definitions in an overridden task.'
        },
        ACTION_NOT_SET: {
            number: 205,
        ...
        RUNSUPER_NOT_AVAILABLE: {
            number: 206,
            message: 'Tried to call runSupper from a non-overridden definition of task "%s"'
        },
        DEFAULT_VALUE_WRONG_TYPE: {
            number: 207,
            message: "Default value for param %s of task %s doesn't match the default one, try specifying it."
        },
        ...
        INVALID_PARAM_NAME_CASING: {
            number: 209,
            message: "Invalid param name %s in task %s. Param names must be camelCase."
        }
    },
    ARGUMENTS: {
        ...
        INVALID_INPUT_FILE: {
            number: 302,
            message: 'Invalid argument "%s": File "%s" doesn\'t exist or is not a readable file.'
        },
        UNRECOGNIZED_TASK: {
            number: 303,
        ...
        UNRECOGNIZED_COMMAND_LINE_ARG: {
            number: 304,
            message: 'Unrecognised command line argument "%s". Note that task arguments must come after the task name.'
        },
    ...
    SOLC: {
        ...
        DOWNLOAD_FAILED: {
            number: 501,
            message: 'Couldn\'t download compiler version "%s". Please check your connection or use local version "%s"'
        },
        VERSION_LIST_DOWNLOAD_FAILED: {
            number: 502,
            message: 'Couldn\'t download compiler versions list. Please check your connection or use local version "%s"'
        },
        INVALID_DOWNLOAD: {
            number: 503,
            message: 'Couldn\'t download compiler version "%s". Checksum verification failed. Please check your connection or use local version "%s"'
        }
    },
    BUILTIN_TASKS: {
        COMPILE_FAILURE: {
    ...
    PLUGINS: {
        ...
        DEPENDENCY_VERSION_MISMATCH: {
            number: 802,
            message: "Plugin %s requires %s version %s but got %s.\n" +
        ...
        OLD_STYLE_IMPORT_DETECTED: {
            number: 803,
            message: "You are trying to load %s with a require or import statement.\n" +
