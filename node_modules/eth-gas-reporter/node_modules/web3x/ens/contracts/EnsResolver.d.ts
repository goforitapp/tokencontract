...
import { Eth } from "../../eth";
export declare type AddrChangedEvent = {
    node: string;
    a: string;
};
export declare type ContentChangedEvent = {
    node: string;
    hash: string;
};
export declare type NameChangedEvent = {
    node: string;
    name: string;
};
export declare type ABIChangedEvent = {
    node: string;
    contentType: string;
};
export declare type PubkeyChangedEvent = {
    node: string;
    x: string;
    y: string;
};
...
export declare class EnsResolver extends Contract<EnsResolverDefinition> {
    constructor(eth: Eth, address?: string, options?: ContractOptions);
}
export declare var EnsResolverAbi: import("../../contract").AbiDefinition[];
export {};
