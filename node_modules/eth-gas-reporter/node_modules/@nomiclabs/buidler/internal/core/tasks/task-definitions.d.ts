import { ActionType, ParamDefinition, ParamDefinitionsMap, TaskArguments, TaskDefinition } from "../../../types";
...
export declare class SimpleTaskDefinition implements TaskDefinition {
     ...
     */
    constructor(name: string, isInternal?: boolean);
    /**
     ...
     * @param isOptional `true` if the parameter is optional. It's default value is `true` if `defaultValue` is not `undefined`.
     */
    addVariadicPositionalParam<T>(name: string, description?: string, defaultValue?: T[] | T, type?: types.ArgumentType<T>, isOptional?: boolean): this;
    /**
     * Adds a positional paramater to the task's definition.
     *
     ...
     * @param type param's type.
     */
    addOptionalVariadicPositionalParam<T>(name: string, description?: string, defaultValue?: T[] | T, type?: types.ArgumentType<T>): this;
    /**
     * Adds a positional paramater to the task's definition.
     *
...
export declare class OverriddenTaskDefinition implements TaskDefinition {
    ...
    private _description?;
    private _action?;
    constructor(parentTaskDefinition: TaskDefinition, isInternal?: boolean);
    setDescription(description: string): this;
    /**
