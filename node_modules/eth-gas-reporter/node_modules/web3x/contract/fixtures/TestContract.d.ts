...
export declare type UnchangedEvent = {
    value: string;
    addressFrom: string;
    t1: string;
};
...
export declare class TestContract extends Contract<TestContractDefinition> {
    constructor(eth: Eth, address?: string, options?: ContractOptions);
}
export declare var TestContractAbi: import("..").AbiDefinition[];
export {};
